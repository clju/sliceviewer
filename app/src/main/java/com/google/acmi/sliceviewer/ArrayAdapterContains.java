...
/**
 * Similar to ArrayAdapter, but matches all Strings that contain the target String (as opposed
 * to all Strings prefixed by the target String).
 */
public class ArrayAdapterContains<T> extends BaseAdapter implements Filterable,
   ...
   *                 instantiating views.
   */
  public ArrayAdapterContains(Context context, int resource) {
   ...
   */
  public ArrayAdapterContains(Context context, int resource, T[] objects) {
  ...
  private ArrayAdapterContains(Context context, int resource,
